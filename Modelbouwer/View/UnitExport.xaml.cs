...
/// <summary>
/// Interaction logic for UnitExport.xaml
/// </summary>
public partial class UnitExport : Page
{
	...
	{
		_dt = DBCommands.GetData( DBNames.UnitTable, "nosort" );

		if ( _dt == null )
		{
			dispFolderName.Text = TryFindResource( "Export.Unit.Empty" ) as string;
			dispStatusLine.Text = TryFindResource( "Export.Unit.Empty" ) as string;
	...
	{
		string _filename = $"{GeneralHelper.GetFilePrefix()}{(string)FindResource("Export.Unit.Filename")}.csv";
