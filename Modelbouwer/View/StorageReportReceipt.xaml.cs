...
/// <summary>
/// Interaction logic for StorageReportReceipt.xaml
/// </summary>
public partial class StorageReportReceipt : Page
{
	public StorageReportReceipt()
	{
		InitializeComponent();
	}
		...
		if ( !string.IsNullOrEmpty( name ) )
		{
			switch ( name )
			{
				case "FilterButton":
					...
					FilterSearchText.Tag = ( string ) FindResource( "Edit.ReceiptReport.DataGrid.FilterSearch.Search.Tag" );
					FilterSearchText.ToolTip = ( string ) FindResource( "Edit.ReceiptReport.DataGrid.FilterSearch.Search.Tooltip" );
					ClearFilterSearch.ToolTip = ( string ) FindResource( "Edit.ReceiptReport.DataGrid.FilterSearch.Search.Clear.Tooltip" );
				...
				case "SearchButton":
					...
					FilterSearchText.Tag = ( string ) FindResource( "Edit.ReceiptReport.DataGrid.FilterSearch.Filter.Tag" );
					FilterSearchText.ToolTip = ( string ) FindResource( "Edit.ReceiptReport.DataGrid.FilterSearch.Filter.Tooltip" );
					ClearFilterSearch.ToolTip = ( string ) FindResource( "Edit.ReceiptReport.DataGrid.FilterSearch.Filter.Clear.Tooltip" );
					//Toggle filtering to show result of toggle directly in datagrid
