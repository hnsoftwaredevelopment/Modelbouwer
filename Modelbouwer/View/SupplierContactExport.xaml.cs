...
/// <summary>
/// Interaction logic for SupplierContactExport.xaml
/// </summary>
public partial class SupplierContactExport : Page
{
	private DataTable? _dt;

	public SupplierContactExport()
	{
		InitializeComponent();
		GetData();
	...
	{
		_dt = DBCommands.GetData( DBNames.SupplierContactTable, "nosort" );

		if ( _dt == null )
		{
			dispFolderName.Text = TryFindResource( "Export.SupplierContact.Empty" ) as string;
			dispStatusLine.Text = TryFindResource( "Export.SupplierContact.Empty" ) as string;
