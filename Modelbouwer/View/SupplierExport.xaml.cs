...
/// <summary>
/// Interaction logic for SupplierExport.xaml
/// </summary>
public partial class SupplierExport : Page
{
	...
	{
		_dt = DBCommands.GetData( DBNames.SupplierTable, "nosort" );

		if ( _dt == null )
		{
			dispFolderName.Text = TryFindResource( "Export.Supplier.Empty" ) as string;
			dispStatusLine.Text = TryFindResource( "Export.Supplier.Empty" ) as string;
	...
	{
		string _filename = $"{GeneralHelper.GetFilePrefix()}{(string)FindResource("Export.Supplier.Filename")}.csv";
