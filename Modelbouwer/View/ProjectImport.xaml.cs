...
public partial class ProjectImport : Page
{
	...
	private void Prepare( object sender, RoutedEventArgs e )
	{
		...
		var _filename = $"{GeneralHelper.GetFilePrefix()}{(string)FindResource("Import.Project.Filename")}.csv";
	...
	{
		var errorIdentifier = 7; //See Error Class for meaning of this number
