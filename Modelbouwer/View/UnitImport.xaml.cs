...
/// <summary>
/// Interaction logic for UnitImport.xaml
/// </summary>
public partial class UnitImport : Page
{
	public UnitImport()
	{
		InitializeComponent();
	...
	private void Import( object sender, RoutedEventArgs e )
	{
		...
		dispStatusLine.Text = GeneralHelper.ProcessCsvFile( DBNames.UnitTable, errorIdentifier, dispFileName.Text, checkField, metadataType );
	}
	#endregion
